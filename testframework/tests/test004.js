describe('Task 4 - Multiple requests', function() {
  var taskDesc =
    '<p>Add functionality to your <code>search()</code> to be able to accept requests from multiple galleries and route the search results to the appropriate gallery instance.</p>' +
  ...
  describe(taskDesc, function() {
    it('accept requests from multiple galleries test', function() {
      ...
      waitsFor(
        function() {
          return (
            gallery._onSearchResultReady.callCount > 0 &&
            gallery2._onSearchResultReady.callCount > 0
          )
        },
