describe('Task 2 - Search Modules', function() {
  var taskDesc =
    '<p>Modify your implementation of <code>ImageFinder</code> to include a way of adding <strong>search modules</strong>. Each module accepts a search query and returns the search results in the same format as task 1.</p>' +
  ...
  describe(taskDesc, function() {
    ...
    it('general return static result test', function() {
      ...
      waitsFor(
        function() {
          return gallery._onSearchResultReady.callCount > 0
        },
        'imageFinder to return results',
        100
      )
      ...
      runs(function() {
        ...
        expect(results.images).toContain({
          ...
          url:
            'http://static.wix.com/media/cc9d8bc0f8b1a5338ee79d9eb155d1c4.wix_mp',
          title: 'small dogs'
        })
        ...
        expect(results.images).toContain({
          ...
          url:
            'http://static.wix.com/media/fb376dd2473759bbb248dc4f1b23730e.wix_mp',
          title: 'dogfood'
        })
        ...
        expect(results.images).toContain({
          ...
          url:
            'http://static.wix.com/media/85252fdf939e9b37fa16d1f3b2d197e9.wix_mp',
          title: 'dog run'
        })
        ...
        expect(results.images).toContain({
          ...
          url:
            'http://static.wix.com/media/16f9f8e6e00718d108a8889351874fb4.wix_mp',
          title: 'book dog'
        })
        ...
        expect(results.images).toContain({
          ...
          url:
            'http://static.wix.com/media/7f093ca6c9945ebb918772e55cd7b89f.wix_mp',
          title: 'office dog'
        })
      })
    })
